export default function DishDeleteModal({ isOpen, dish, onClose, onConfirm }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative bg-surface-container-lowest w-full max-w-[420px] overflow-hidden rounded-xl shadow-2xl flex flex-col animate-slide-in">
        <div className="px-8 py-6 border-b border-border-subtle">
          <h2 className="font-headline-md text-headline-md font-bold text-on-surface">تأكيد حذف الطبق</h2>
          <p className="text-secondary font-body-md mt-2">
            هل أنت متأكد من حذف الطبق <span className="font-bold text-on-surface">«{dish.name}»</span>؟
          </p>
